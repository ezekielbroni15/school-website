...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $formSource = "PHA Website Contact Form";
    ...
    $email_subject = "New Message from PHA Website: $subject";
    $email_body = "You have received a new message from the Pinnacle Heights Academy website.\n\n";
    ...
    $email_headers = "From: PHA Website <noreply@pha.edu.gh>\r\n";
    ...
    // Send email
    $recipient = "Paul.antwi@pha.edu.gh";
